...
:: TODO --> Move the Windows Form Application to the Unity Project (on compilation)
...
set dst=C:\Users\msrladmin\Documents\GitHub\ART_v5_1\ART_5_1\ART_Project_5_1\Assets\ART_Dialog.exe
copy %src% %dst% /Y